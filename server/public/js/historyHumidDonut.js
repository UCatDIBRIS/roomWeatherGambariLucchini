...
var dataHumid = [
      {name: 'humidity', count: averageHumidity, percentage: averageHumidity, color: 'steelblue'},
      {name: 'rest', count: 100-averageHumidity, percentage: 100-averageHumidity, color: '#e6e6e6'}
    ];
...
function updateDataHumidDonut(){
	updateHumid()
	d3.select('#idHumid').text(averageHumidity+"%")
}
